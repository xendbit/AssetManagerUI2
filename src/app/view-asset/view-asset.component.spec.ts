...
describe('ViewAssetComponent Unit Test', () => {
  ...
  describe('getBalance() function unit test', () => {
    ...
    xit('throw an error and set value to this.error object', fakeAsync(() => {
      const error = {
        error: {
            "status": "error",
            "data": {
  ...
  describe('getAssetDetails() function unit test', () => {

    xit('should call AssetsService.getAssetsByTokenId() and set value to asset', fakeAsync(() => {
      AssetsServiceSpy.getAssetsByTokenId.and.returnValue(of(getAssetsByTokenIdResp));
  ...
  describe('sell() function unit test', () => {
    ...
    xit('should call sell(), throw an error and set value to this.error object', fakeAsync(() => {
        const error = {
            error: {
                "status": "error",
                "data": {
  ...
  describe('approve() function unit test', () => {
    ...
    xit('should call approve(), throw an error and set value to this.error object', fakeAsync(() => {
        const error = {
            error: {
                "status": "error",
                "data": {
