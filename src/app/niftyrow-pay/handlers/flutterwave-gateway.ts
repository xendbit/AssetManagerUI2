...
import { IPaymentGatewayDetails, IPayment, IFieldlist, GatewayTypes, ISingleItemPayment } from 'src/app/core/interfaces/payment.interfaces';
...
export class FlutterwaveGateway  {
  ...
  verifyPaymentRef(_serverUrl,_transactionRef){
    ...
    return this.http.get(_serverUrl + 'tx_ref=' + _transactionRef,{});
  }
